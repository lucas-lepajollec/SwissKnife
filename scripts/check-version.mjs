...
if (!packageJson.private) throw new Error('The application package must stay private; SwissKnife is distributed as an app/container, not through npm.');
...
console.log(`SwissKnife version contract verified: ${version}`);
